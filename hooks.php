 ...
 * 
 * @package KsfFA_ksf_FA_Onboarding
 * @version 2.4.3
 */

define('SS_ksf_FA_Onboarding', 132 << 8);
...
class hooks_ksf_FA_Onboarding extends hooks {
    ...
    function install_tabs($app) {
        ...
        // return new ksf_FA_Onboarding_app();
    }
    ...
    function install_access() {
        ...
        $security_areas['SA_ksf_FA_OnboardingVIEW'] = array(
            SS_ksf_FA_Onboarding | 1, 
            _("View ")
        );
        $security_areas['SA_ksf_FA_OnboardingMANAGE'] = array(
            SS_ksf_FA_Onboarding | 2, 
            _("Manage ")
        );
