<?php
/**
 * ksf_FA_Onboarding Module Hooks for FrontAccounting
 */

define('SS_ksf_FA_Onboarding', 100 << 8);

class hooks_ksf_FA_Onboarding extends hooks {
    var $module_name = 'ksf_FA_Onboarding';
    ...
    function install_access() {
        $security_sections[SS_ksf_FA_Onboarding] = _("");
        $security_areas['SA_ksf_FA_OnboardingVIEW'] = array(SS_ksf_FA_Onboarding | 1, _("View "));
        $security_areas['SA_ksf_FA_OnboardingMANAGE'] = array(SS_ksf_FA_Onboarding | 2, _("Manage "));
